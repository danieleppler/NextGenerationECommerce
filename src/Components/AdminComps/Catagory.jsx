  ...
  return (
    <div className='row'>
      ...
      {textClicked?
        ...
        <Button className='col-md-4 offset-md-2' onClick ={handleUpdate} variant="dark">update</Button>
        </div>
        </div>
        :
        <div >
        <Card.Text onClick={handleClick}><strong>{props.Title}</strong></Card.Text>
        <div className='row'>
